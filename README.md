...
- **Plugin System** - WASM-based plugin extensibility with process-backed command plugins (Phase 4): project-local slash commands can declare `runtime: process` to run executables with structured JSON output, timeout, and output capping
