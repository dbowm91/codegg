...
| [test_runner/](test_runner.md) | Test command resolution, failure extraction, output parsing, report formatting, and previous-failures index | `types.rs`, `resolve.rs`, `parse.rs`, `report.rs`, `runner.rs`, `index.rs`, `mod.rs` |
