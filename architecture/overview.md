...
| [test_runner/](test_runner.md) | Test command resolution, failure extraction, output parsing, and report formatting | `types.rs`, `resolve.rs`, `parse.rs`, `report.rs`, `runner.rs`, `mod.rs` |
