...
| `release-full` | Conservative full validation for main/tags | Serial | `cargo test --workspace --all-features -- --test-threads=8` |
...
3. **Limited parallelism is reliable** — `--test-threads=8` balances speed with resource control.
