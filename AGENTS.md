...
| Root composite test count | 20 | `tests/lsp_composite_stdio.rs` — exercises `SemanticContextCollector`, `DiagnosticsCollector`, `LspOperations`, and security context tool orchestration against fake server via production stack |
