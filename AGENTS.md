...
| egglsp-test-server crate | `crates/egglsp-test-server` | Fake LSP server binary for deterministic integration testing. Reads Content-Length framed JSON-RPC, executes scripted scenarios, writes machine-readable transcripts. |
