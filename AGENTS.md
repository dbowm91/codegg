...
| Root composite test count | 19 | `tests/lsp_composite_stdio.rs` — exercises `SemanticContextCollector`, `DiagnosticsCollector`, and `LspOperations` against fake server via production stack |
