...
| `SecurityContextExecutorProvider` | Provider abstraction for obtaining a security context executor at command execution time. Avoids hardwiring `NoopSecurityContextExecutor` in command handlers. | `src/security/workflow/context.rs` |
