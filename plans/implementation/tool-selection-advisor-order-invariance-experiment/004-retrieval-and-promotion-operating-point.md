...
Status: implemented (negative — no K<=32 clears preregistered retrieval gates; see `plans/closure/tool-selection-advisor-order-invariance-experiment/004-status.md`)
