...
| M007 | active | `plans/implementation/coding-agent-tool-surface-corrective/007-m003-m004-closure-evidence-reconciliation.md` | — | M003/M004 production implementations exist; qualification in progress. |
