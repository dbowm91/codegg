...
| M006 | closing | `plans/implementation/coding-agent-tool-surface-corrective/006-lsp-preview-runtime-authority-seam.md` | `plans/closure/coding-agent-tool-surface-corrective/006-status.md` | Implementation landed; closure evidence review in progress. |
