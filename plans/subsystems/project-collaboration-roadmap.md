...
| M002 | closed | `plans/implementation/project-collaboration/002-tui-project-chat-and-observer-routing.md` | `plans/closure/project-collaboration/002-status.md` | — (unblocked by M001 closure) |
| M003 | closed | `plans/implementation/project-collaboration/003-structured-chat-actions.md` | `plans/closure/project-collaboration/003-status.md` | — (subsystem complete: M001+M002+M003 closed) |
