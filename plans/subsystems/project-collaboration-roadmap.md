...
|---|---|---|---|---|
| M001 | blocked | `plans/implementation/project-collaboration/001-project-channel-message-protocol.md` | — | identity-authorization-audit M005; presence-observation M003 |
