...
|---|---|---|---|---|
| M001 | ready | `plans/implementation/interactive-process-sessions/001-scheduler-owned-pty-engine.md` | — | — |
| M002 | blocked | `plans/implementation/interactive-process-sessions/002-bounded-attach-resume-protocol.md` | — | M001 |
