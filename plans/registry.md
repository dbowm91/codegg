...
|---|---|---|---|---|
| Project Work Orders and Task View | active | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002+M003+M004+M005+M006 closed; M007 ready | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001+M002+M003+M004+M005+M006 satisfy M007 dependencies. |
...
| Project Work Orders and Task View | M007 trajectory/recovery/security qualification | ready | `plans/implementation/project-work-orders-task-view/007-work-order-trajectory-and-recovery-qualification.md` | Hard M001-M006 dependencies closed (M001 `a856f2e0`, M002 `c54656e5`, M003 `79a00460`, M004 `8c6e8190`, M005 `f22c9d8d`, M006 `38e533a8`). |
...
1. Project Work Orders and Task View M001+M002+M003+M004+M005+M006 are closed under accepted ADR-0005 (M001: durable WorkOrder/Occurrence/SequenceLane domain, project-scoped authorization/protocol, CAS mutation foundation, no execution; M002: release coordinator with exactly-once claim/materialization into ordinary sessions/jobs through `JobSubmissionService`, managed-worktree isolation, model/policy narrowing; M003: Task composer/scheduling sheet/project Task view with CAS reorder and separately-scoped Task-model preference, `/tasks` migration; M004: global Workspace dashboard with bounded authorized project/task/session/attention projection, `/workspace` + hotkey, lazy detail, team privacy, event/reconnect/revocation guards; M005: narrow external task-trigger capability with verifier-only storage, authenticated/idempotent POST fire endpoint, expiry/max-fire/revocation, replay/race safety, plus the `ConnectInfo` server-wiring repair found by its HTTP qualification). Closure evidence at `plans/closure/project-work-orders-task-view/001-status.md` (implementation `a856f2e0`), `plans/closure/project-work-orders-task-view/002-status.md` (implementation `c54656e5`), `plans/closure/project-work-orders-task-view/003-status.md` (implementation `79a00460`), `plans/closure/project-work-orders-task-view/004-status.md` (implementation `8c6e8190`), and `plans/closure/project-work-orders-task-view/005-status.md` (implementation `f22c9d8d`), and `plans/closure/project-work-orders-task-view/006-status.md` (implementation `38e533a8`). M006 is closed (dedicated agent WorkOrder tool with atomic sequential batches at `plans/closure/project-work-orders-task-view/006-status.md`, implementation `38e533a8`). M007 is dependency-ready on M001-M006 closures.
...
| Project Work Orders and Task View | M007 trajectory/recovery/security qualification | Hard M001-M006 dependencies satisfied (M001 `a856f2e0`, M002 `c54656e5`, M003 `79a00460`, M004 `8c6e8190`, M005 `f22c9d8d`, M006 `38e533a8`) — ready for handoff. Plan: `plans/implementation/project-work-orders-task-view/007-work-order-trajectory-and-recovery-qualification.md`. |
