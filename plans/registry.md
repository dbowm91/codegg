...
|---|---|---|---|---|
| Project Work Orders and Task View — UX fidelity corrective | ready | `plans/subsystems/project-work-orders-task-view-ux-corrective-addendum.md` | C001 ready | Closed M003 Task composer/view, M005 trigger backend, and M007 qualification are hard dependencies and are satisfied. Corrects Tab composer selection, focused direct queue reorder, and human trigger setup/recovery without reopening backend ownership. |
| Project Work Orders and Task View | closed | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002+M003+M004+M005+M006+M007 closed | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001-M007 satisfy the durable capability; the separate UX-fidelity corrective above owns post-closure human-surface gaps. |
...
|---|---|---|---|---|
| Project Work Orders and Task View — UX fidelity corrective | C001 human Task UX and trigger surface | ready | `plans/implementation/project-work-orders-task-view-corrective/001-human-task-ux-and-trigger-surface.md` | M003/M005/M007 are closed; this is the only dependency-ready WorkOrder corrective milestone. |
...
|---|---|---|
| Project Work Orders and Task View — UX fidelity corrective | C001 ready | `plans/subsystems/project-work-orders-task-view-ux-corrective-addendum.md`; `plans/implementation/project-work-orders-task-view-corrective/001-human-task-ux-and-trigger-surface.md`; predecessor M003/M005/M007 closure records; accepted ADR-0005/ADR-0004; current TUI WorkOrder and M005 trigger-management surfaces |
