...
|---|---|---|---|---|
| Team collaboration, shared sessions, and Workspace chat — corrective | active | `plans/subsystems/team-collaboration-corrective-addendum.md` | M001 closed; M002/M004 ready; M003/M005/M006 blocked | M001 network authorization convergence closed (`plans/closure/team-collaboration-corrective/001-status.md`; implementation `cc41e4a4`); M002 and M004 unblocked to ready; M003/M005 remain blocked on M002; M006 remains blocked on M001-M005. ADR-0006 and ADR-0007 accepted. |
...
| Team collaboration corrective | M002 project/channel chat access policy | ready | `plans/implementation/team-collaboration-corrective/002-project-channel-chat-access-policy.md` | Unblocked by M001 closure; hard dependency satisfied; consumes accepted ADR-0006. |
...
**Team collaboration corrective gate:** M001 network authorization convergence is closed (`plans/closure/team-collaboration-corrective/001-status.md`; implementation `cc41e4a4`). M002 and M004 are ready and may proceed; M003 and M005 additionally require M002; M006 is the final cross-cutting qualification gate. See `plans/subsystems/team-collaboration-corrective-addendum.md`.
...
|---|---|---|
| Team collaboration corrective | M003 team membership and device-token administration | Blocked on M001 + M002 strict closure (M001 closed; M002 ready). |
| Team collaboration corrective | M005 Workspace selected-project chat view | Blocked on M001 + M002 strict closure (M001 closed; M002 ready). |
| Team collaboration corrective | M006 multi-user trajectory/security qualification | Blocked on M001-M005 strict closure (M001 closed; M002/M004 ready). |
