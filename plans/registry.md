...
|---|---|---|---|---|
| Project Work Orders and Task View | ready | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001 ready; M002-M007 blocked on ordered predecessors | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations satisfy M001 dependencies. M002-M007 are registered below and remain blocked until their declared predecessor closures. |
...
|---|---|---|---|---|
| Project Work Orders and Task View | M001 WorkOrder domain, storage, authorization, and protocol foundation | ready | `plans/implementation/project-work-orders-task-view/001-work-order-domain-storage-protocol.md` | ADR-0005 accepted; closed project/catalog/session/jobs/authorization foundations satisfy hard dependencies. This is the only dependency-ready WorkOrder milestone. |
...
1. Project Work Orders and Task View M001 is dependency-ready under accepted ADR-0005. It establishes the durable WorkOrder/Occurrence/SequenceLane domain, project-scoped authorization/protocol, and CAS mutation foundation. M002-M007 remain blocked and MUST NOT be started by treating their plan files as independent ready work.
...
|---|---|---|
| Project Work Orders and Task View | M002 release coordinator/session materialization | Blocked on M001 closure. Plan: `plans/implementation/project-work-orders-task-view/002-release-coordinator-session-materialization.md`. |
...
|---|---|---|
| Project Work Orders and Task View | M001 ready; M002-M007 blocked | `plans/adrs/ADR-0005-project-work-orders-and-task-orchestration.md`; `plans/subsystems/project-work-orders-task-view-roadmap.md`; seven implementation plans under `plans/implementation/project-work-orders-task-view/`; existing project/session/jobs/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations |
