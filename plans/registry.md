...
| Execution reliability, approval, and autonomy | M005 production sandbox policy wiring | active | `plans/implementation/execution-reliability-approval-autonomy/005-production-sandbox-policy-wiring.md` | M003 execution-policy/ApprovalRouter contract closed (immutable snapshot, router, sandbox profile preference, child ceiling). |
...
2. Execution-reliability M001+M002+M003+M004 are closed (provider attempt safety/taxonomy at `plans/closure/execution-reliability-approval-autonomy/001-status.md`; unified retry budget at `plans/closure/execution-reliability-approval-autonomy/002-status.md`; ApprovalRouter/persistence at `plans/closure/execution-reliability-approval-autonomy/003-status.md`; model/preference convergence at `plans/closure/execution-reliability-approval-autonomy/004-status.md`). M005 is ready on the M003 contract. M006 follows M003+M005, M007 follows M003-M006 (M004 closed), and M008 is final qualification (M001+M002+M003+M004 legs satisfied; still blocked on M005-M007).
...
| Execution reliability, approval, and autonomy | M006 automatic approval reviewer | M005 closure (M003 closed). |
| Execution reliability, approval, and autonomy | M007 Yolo/Automatic/FullHost user surfaces | M005-M006 closure (M003+M004 closed). |
| Execution reliability, approval, and autonomy | M008 fault-injection and reliability qualification | M005-M007 closure (M001+M002+M003+M004 closed). |
