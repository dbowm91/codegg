...
|---|---|---|---|---|
| Project Work Orders and Task View | active | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002+M003+M004 closed; M005 ready; M006-M007 blocked | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001+M002+M003+M004 satisfy M005 dependencies. M006-M007 are registered below and remain blocked until their declared predecessor closures. |
...
| Project Work Orders and Task View | M005 external task-trigger endpoint | ready | `plans/implementation/project-work-orders-task-view/005-external-task-trigger-endpoint.md` | Hard M002 dependency closed (`plans/closure/project-work-orders-task-view/002-status.md`); ordering gate M004 closed (`plans/closure/project-work-orders-task-view/004-status.md`). M004 is not a semantic dependency of the trigger service. |
...
|---|---|---|
| Project Work Orders and Task View | M005 external task-trigger endpoint | Hard M002 dependency satisfied (`plans/closure/project-work-orders-task-view/002-status.md`); ordering gate M004 satisfied (`plans/closure/project-work-orders-task-view/004-status.md`) — ready for handoff. Plan: `plans/implementation/project-work-orders-task-view/005-external-task-trigger-endpoint.md`. |
