...
|---|---|---|---|---|
| Upstream tool-surface compatibility corrective | active | `plans/subsystems/tool-surface-upstream-compatibility-corrective-addendum.md` | M007 closed; M008 ready | M006 → M007 satisfied; M008 independent. Audited against eggsearch 0.3.9 and eggsact 1.2.5. |
...
|---|---|---|
| Upstream tool-surface compatibility corrective | active | `plans/subsystems/tool-surface-upstream-compatibility-corrective-addendum.md`; M007 closure plus M008 implementation plan |
