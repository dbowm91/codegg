...
| Project collaboration | active | `plans/subsystems/project-collaboration-roadmap.md` | M001 closed, M002+M003 ready | M002/M003 unblocked by collaboration M001 closure (`plans/closure/project-collaboration/001-status.md`). |
...
| Project collaboration | M002 — TUI project chat and observer input routing | `plans/implementation/project-collaboration/002-tui-project-chat-and-observer-routing.md` | Collaboration M001 closed (`plans/closure/project-collaboration/001-status.md`); presence-observation M003 and multi-project TUI closed. |
| Project collaboration | M003 — separately authorized structured chat actions | `plans/implementation/project-collaboration/003-structured-chat-actions.md` | Collaboration M001 closed (`plans/closure/project-collaboration/001-status.md`); identity/audit M005 and agent-run/job owners closed. |
...
4. Project collaboration M001 is closed (channel/message/sync contract landed with ordering/retry/restart/retention/auth/privacy evidence). M002 TUI chat and M003 structured actions may now proceed in parallel. Chat UI and structured actions follow M001. Free text is never an execution interface.
