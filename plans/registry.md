...
|---|---|---|---|---|
| Long-horizon work execution | active | `plans/subsystems/long-horizon-work-execution-roadmap.md` | M001 closed; M002 ready; M003-M005 dependency-blocked | ADR-0003 accepted; M001 closed (`plans/closure/long-horizon-work-execution/001-status.md`). M002 ready on the M001 contract, then M003-M005 are dependency ordered. |
...
| Long-horizon work execution | M002 durable WorkPlan foundation | ready | `plans/implementation/long-horizon-work-execution/002-durable-work-plan-foundation.md` | Unblocked by M001 closure; interface dependency on ADR-0003 and closed session/storage infrastructure satisfied. |
...
1. Long-horizon M001 is closed (Goal progress/wait/no-progress correctness at `plans/closure/long-horizon-work-execution/001-status.md`). M002 durable WorkPlan is ready; M003 projection/completion arbitration follows M002 closure, then M004 context-epoch integration, and M005 trajectory qualification.
...
| Long-horizon work execution | M005 long-horizon trajectory qualification | M002-M004 closure (M001 closed). |
