...
|---|---|---|---|---|
| Long-horizon work execution | active | `plans/subsystems/long-horizon-work-execution-roadmap.md` | M001+M002 closed; M003 ready; M004-M005 dependency-blocked | ADR-0003 accepted; M001 closed (`plans/closure/long-horizon-work-execution/001-status.md`); M002 closed (`plans/closure/long-horizon-work-execution/002-status.md`). M003 ready on the M002 contract, then M004-M005 are dependency ordered. |
...
| Long-horizon work execution | M003 WorkPlan projection and completion arbiter | ready | `plans/implementation/long-horizon-work-execution/003-work-plan-projection-and-completion-arbiter.md` | Unblocked by M002 closure; hard dependency on M002 satisfied. |
...
1. Long-horizon M001+M002 are closed (Goal progress/wait/no-progress correctness at `plans/closure/long-horizon-work-execution/001-status.md`; durable WorkPlan foundation at `plans/closure/long-horizon-work-execution/002-status.md`). M003 projection/completion arbitration is ready; then M004 context-epoch integration, and M005 trajectory qualification.
...
| Long-horizon work execution | M005 long-horizon trajectory qualification | M003-M004 closure (M001+M002 closed). |
