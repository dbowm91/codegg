...
|---|---|---|---|---|
| Long-horizon work execution | active | `plans/subsystems/long-horizon-work-execution-roadmap.md` | M001+M002+M003+M004 closed; M005 ready | ADR-0003 accepted; M001 closed (`plans/closure/long-horizon-work-execution/001-status.md`); M002 closed (`plans/closure/long-horizon-work-execution/002-status.md`); M003 closed (`plans/closure/long-horizon-work-execution/003-status.md`); M004 closed (`plans/closure/long-horizon-work-execution/004-status.md`). M005 ready on the M004 contract. |
...
| Long-horizon work execution | M005 long-horizon trajectory and recovery qualification | ready | `plans/implementation/long-horizon-work-execution/005-long-horizon-trajectory-and-recovery-qualification.md` | Unblocked by M004 closure; hard dependencies on M001-M004 satisfied. |
