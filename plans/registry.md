...
| Self-contained installation corrective | active | `plans/subsystems/self-contained-installation-corrective-addendum.md` | M001 closed; M002 ready | M001 managed runfile bundle closed (`plans/closure/self-contained-installation-corrective/001-status.md`; implementation `f9ec8602`); M002 runtime resolution and clean-host qualification ready (M001 + provider-connect M003 preconditions closed). |
...
| Self-contained installation corrective | M002 runtime resolution and clean-host qualification | ready | `plans/implementation/self-contained-installation-corrective/002-runtime-resolution-and-clean-host-qualification.md` | Unblocked: M001 closed and Provider /connect Restoration M003 closed. Class: capability. |
...
11. Self-contained installation M001 is closed: release archives carry the exact managed runfile bundle (`codegg`, `codegg-sandbox-helper`, `codegg-eggsearch`, plus optional fixed `THIRD-PARTY-NOTICES.txt`; explicit `.exe` names on Windows) with pinned eggsearch 0.3.9 provenance, and the installer commits the bundle transactionally with backup/rollback. Closure evidence at `plans/closure/self-contained-installation-corrective/001-status.md` (implementation `f9ec8602`). M002 runtime resolution and clean-host qualification is ready: both its preconditions (M001 and Provider /connect Restoration M003) are closed.
