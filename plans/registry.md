...
|---|---|---|---|---|
| Team collaboration, shared sessions, and Workspace chat — corrective | active | `plans/subsystems/team-collaboration-corrective-addendum.md` | M001 ready; M002-M006 blocked by campaign dependencies | M001 is the security gate; ADR-0006 and ADR-0007 accepted. |
...
|---|---|---|---|---|
| Team collaboration corrective | M001 network API authorization convergence | ready | `plans/implementation/team-collaboration-corrective/001-network-api-authorization-convergence.md` | Closed identity/authorization foundation; must close before any new team-facing policy/UX milestone. |
...
**Team collaboration corrective gate:** execute M001 network authorization convergence first. M002 and M004 may proceed after M001; M003 and M005 additionally require M002; M006 is the final cross-cutting qualification gate. See `plans/subsystems/team-collaboration-corrective-addendum.md`.
...
|---|---|---|
| Team collaboration corrective | M002 project/channel chat access policy | Blocked on M001 strict closure; consumes accepted ADR-0006. |
| Team collaboration corrective | M003 team membership and device-token administration | Blocked on M001 + M002 strict closure. |
| Team collaboration corrective | M004 shared-session controller lease | Blocked on M001 strict closure; consumes accepted ADR-0007. |
| Team collaboration corrective | M005 Workspace selected-project chat view | Blocked on M001 + M002 strict closure. |
| Team collaboration corrective | M006 multi-user trajectory/security qualification | Blocked on M001-M005 strict closure. |
