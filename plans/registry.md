...
| Tool-selection advisor sequence-encoder experiment | M004 hybrid semantic/BM25 candidate retrieval | ready | `plans/implementation/tool-selection-advisor-sequence-encoder-experiment/005-hybrid-retrieval-shortlist-experiment.md` | M003 positive packed-marker result closed; evaluate deferred-only BM25/semantic/RRF/normalized-union K=16/24/32 frontier and fallback/authority regressions. |
