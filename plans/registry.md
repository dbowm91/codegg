...
| Tool-selection advisor post-closure corrective | M004 live small-model trajectory qualification | M001-M003 are closed; blocked on operator-configured live primary-model/provider calls, frozen held-out trajectory fixtures, and resource measurements required by the plan. |
