...
|---|---|---|---|---|
| Runtime consolidation, deletion, and footprint | M003 — AgentLoop ownership decomposition | ready | `plans/implementation/runtime-consolidation-deletion-footprint/003-agent-loop-ownership-decomposition.md` | M002 is closed; M001 is closed; M004 remains a soft coordination dependency. |
