...
|---|---|---|---|---|
| Context continuity and multi-compaction coherence | active | `plans/subsystems/context-continuity-compaction-roadmap.md` | M001+M002 closed; M003 ready; M004 dependency-gated | M003 unblocked by M001 closure; M004 requires M002+M003 closure (M002 done, M003 still open). |
...
## Dependency-gated implementation plans
...
1. Context continuity M001+M002 are closed: the durable checkpoint/epoch store (M001) and the authoritative intent/plan/frame projection (M002, in-memory candidates, no durable rollover change) have landed. M003 remains dependency-ready and may proceed; M004 remains gated on M002+M003 accepted closure (M003 still open).
