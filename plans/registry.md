...
| Tool-selection advisor sequence-encoder experiment | M002 current-state advisor context v2 | ready | `plans/implementation/tool-selection-advisor-sequence-encoder-experiment/003-current-state-advisor-context-v2.md` | Replace stale original-prompt-only projection with bounded current Goal/Task/error context. |
