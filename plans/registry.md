...
| Tool-selection advisor post-closure corrective | M001 dataset/split/consent integrity | ready | `plans/implementation/tool-selection-advisor-post-closure-corrective/001-dataset-split-and-consent-integrity.md` | Predecessor M001/M004 infrastructure is closed; expands evidence and makes consent authority unambiguous before encoder work. |
