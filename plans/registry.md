...
| Identity, authorization, and audit | active | `plans/subsystems/identity-authorization-audit-roadmap.md` | M001 ready | M002-M005 form a hard dependency chain behind M001. |
...
| Identity, authorization, and audit | M001 — principal/membership/capability domain | `plans/implementation/identity-authorization-audit/001-principal-membership-capability-domain.md` | Typed identity/project foundations are closed; transport auth is downstream. |
...
2. Identity/auth/audit is intentionally sequential: M001 domain -> M002 transport identity -> M003 daemon authorization/attribution -> M004 audit store -> M005 instrumentation closure.
3. Presence M001 cannot begin before identity M003 closes. Presence M002 follows M001; M003 follows M001/M002 and consumes the already-closed session-projection interface.
...
| Identity, authorization, and audit | M002 transport authentication | M001 closure. |
