...
2. Execution-reliability M001+M002 are closed (provider attempt safety/taxonomy at `plans/closure/execution-reliability-approval-autonomy/001-status.md`; unified retry budget at `plans/closure/execution-reliability-approval-autonomy/002-status.md`). M003 remains independently ready and parallel-safe. M004/M005/M006/M007 follow the M003 policy/preference chain as defined by the roadmap. M008 is final qualification (M001+M002 legs satisfied; still blocked on M003-M007).
