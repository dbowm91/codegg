...
|---|---|---|---|---|
| Project Work Orders and Task View | active | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002+M003+M004+M005 closed; M006 ready; M007 blocked | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001+M002+M003+M004+M005 satisfy M006 dependencies. M007 is registered below and remains blocked until M001-M006 closures. |
...
| Project Work Orders and Task View | M006 agent WorkOrder tool and atomic batches | ready | `plans/implementation/project-work-orders-task-view/006-agent-work-order-tool-and-batches.md` | Hard M002/M001-service dependencies closed (`plans/closure/project-work-orders-task-view/002-status.md`); ordering gate M005 closed (`plans/closure/project-work-orders-task-view/005-status.md`). |
...
|---|---|---|
| Project Work Orders and Task View | M006 agent WorkOrder tool and atomic batches | Hard M002/M001-service dependencies satisfied (`plans/closure/project-work-orders-task-view/002-status.md`); ordering gate M005 satisfied (`plans/closure/project-work-orders-task-view/005-status.md`) — ready for handoff. Plan: `plans/implementation/project-work-orders-task-view/006-agent-work-order-tool-and-batches.md`. |
| Project Work Orders and Task View | M007 trajectory/recovery/security qualification | Blocked on M001-M006 closure. Plan: `plans/implementation/project-work-orders-task-view/007-work-order-trajectory-and-recovery-qualification.md`. |
...
|---|---|---|
| Project Work Orders and Task View | M001+M002+M003+M004+M005 closed; M006 ready; M007 blocked | `plans/adrs/ADR-0005-project-work-orders-and-task-orchestration.md`; `plans/subsystems/project-work-orders-task-view-roadmap.md`; seven implementation plans under `plans/implementation/project-work-orders-task-view/`; `plans/closure/project-work-orders-task-view/001-status.md`; `plans/closure/project-work-orders-task-view/002-status.md`; `plans/closure/project-work-orders-task-view/003-status.md`; `plans/closure/project-work-orders-task-view/004-status.md`; `plans/closure/project-work-orders-task-view/005-status.md`; existing project/session/jobs/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations |
