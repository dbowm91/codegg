...
| Command surface reconciliation corrective | active | `plans/subsystems/command-surface-reconciliation-corrective-addendum.md` | M001 active; M002 ready (independent of M001) | Corrective addendum open; M001 implementation in progress. |

## Dependency-ready implementation plans

| Subsystem | Milestone | Status | Implementation plan | Dependencies / handoff note |
|---|---|---|---|---|
| Command surface reconciliation corrective | M001 TUI command action convergence | active | `plans/implementation/command-surface-reconciliation-corrective/001-tui-command-action-convergence.md` | Implementation in progress; independent of M002. |
