...
| Tool-selection advisor | active | `plans/subsystems/tool-selection-advisor-roadmap.md` | M005 ready | Accepted ADR-0009; M001-M004 closed with benchmark/runtime/training/consent evidence. |
...
| Tool-selection advisor | M005 advisor integration/qualification | active | `plans/implementation/tool-selection-advisor/005-advisor-integration-and-qualification.md` | M001-M004 closure records accepted; qualification is in progress. |
