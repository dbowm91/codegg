...
| Tool-selection advisor sequence-encoder experiment | active | `plans/subsystems/tool-selection-advisor-sequence-encoder-experiment-roadmap.md` | P001 closed; M001 + M002 ready | New true sequence-encoder experiment using fixed clean evidence infrastructure; M003-M005 gated. Live M004 remains blocked until a positive M005 disposition. |
