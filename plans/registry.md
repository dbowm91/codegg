...
| Tool-selection advisor sequence-encoder experiment | active | `plans/subsystems/tool-selection-advisor-sequence-encoder-experiment-roadmap.md` | M001 conditionally closed; M002 closed; M003 blocked | Candle framework spike landed; M003 additionally requires real local pretrained reference-asset evidence. M004-M005 remain gated. Live M004 remains blocked until a positive M005 disposition. |
...
**Tool-selection advisor sequence-encoder experiment gate:** `plans/subsystems/tool-selection-advisor-sequence-encoder-experiment-roadmap.md` is active. P001 evidence/preregistration polish and M002 current-state advisor context v2 are closed; M001 selected Candle but is conditionally closed pending real local pretrained reference-asset evidence. M003 true sequence-encoder ranking is blocked on that M001 condition; M004 hybrid retrieval is blocked on M003; M005 clean offline qualification is blocked on P001+M002+M003+M004. The existing live-primary-model M004 remains blocked unless M005 records a positive disposition. The experiment must not mutate frozen C001 test/family-holdout labels or weaken ADR-0009 locality/authority constraints.
