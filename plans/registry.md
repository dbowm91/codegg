...
|---|---|---|---|---|
| Project Work Orders and Task View | active | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002 closed; M003 ready; M004-M007 blocked on ordered predecessors | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001+M002 satisfy M003 dependencies. M004-M007 are registered below and remain blocked until their declared predecessor closures. |
...
|---|---|---|---|---|
| Project Work Orders and Task View | M003 project Task composer/view | ready | `plans/implementation/project-work-orders-task-view/003-project-task-composer-and-view.md` | M002 closed (`plans/closure/project-work-orders-task-view/002-status.md`); this is the only dependency-ready WorkOrder milestone. |
...
1. Project Work Orders and Task View M001+M002 are closed under accepted ADR-0005 (M001: durable WorkOrder/Occurrence/SequenceLane domain, project-scoped authorization/protocol, CAS mutation foundation, no execution; M002: release coordinator with exactly-once claim/materialization into ordinary sessions/jobs through `JobSubmissionService`, managed-worktree isolation, model/policy narrowing). Closure evidence at `plans/closure/project-work-orders-task-view/001-status.md` (implementation `a856f2e0`) and `plans/closure/project-work-orders-task-view/002-status.md` (implementation `c54656e5`). M003 is dependency-ready on those closures. M004-M007 remain blocked and MUST NOT be started by treating their plan files as independent ready work.
...
|---|---|---|
| Project Work Orders and Task View | M004 global Workspace dashboard | Blocked on M003 closure. Plan: `plans/implementation/project-work-orders-task-view/004-global-workspace-dashboard.md`. |
| Project Work Orders and Task View | M005 external task-trigger endpoint | Hard M002 dependency satisfied (`plans/closure/project-work-orders-task-view/002-status.md`); held after M004 for ordered handoff clarity. Plan: `plans/implementation/project-work-orders-task-view/005-external-task-trigger-endpoint.md`. |
| Project Work Orders and Task View | M006 agent WorkOrder tool and atomic batches | Hard M002/M001 service dependencies satisfied (`plans/closure/project-work-orders-task-view/002-status.md`); held after M005 for ordered handoff clarity. Plan: `plans/implementation/project-work-orders-task-view/006-agent-work-order-tool-and-batches.md`. |
