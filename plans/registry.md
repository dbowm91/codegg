...
|---|---|---|---|---|
| Project Work Orders and Task View | active | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001 closed; M002 ready; M003-M007 blocked on ordered predecessors | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001 satisfy M002 dependencies. M003-M007 are registered below and remain blocked until their declared predecessor closures. |
...
|---|---|---|---|---|
| Project Work Orders and Task View | M002 release coordinator and session materialization | ready | `plans/implementation/project-work-orders-task-view/002-release-coordinator-session-materialization.md` | M001 closed (`plans/closure/project-work-orders-task-view/001-status.md`); closed scheduler/session/worktree/authorization foundations satisfy remaining hard dependencies. This is the only dependency-ready WorkOrder milestone. |
...
1. Project Work Orders and Task View M001 is closed under accepted ADR-0005 (durable WorkOrder/Occurrence/SequenceLane domain, project-scoped authorization/protocol, CAS mutation foundation, no execution). Closure evidence at `plans/closure/project-work-orders-task-view/001-status.md`; implementation `a856f2e0`. M002 is dependency-ready on that closure. M003-M007 remain blocked and MUST NOT be started by treating their plan files as independent ready work.
...
|---|---|---|
| Project Work Orders and Task View | M003 project Task composer/view | Blocked on M002 closure. Plan: `plans/implementation/project-work-orders-task-view/003-project-task-composer-and-view.md`. |
...
| Project Work Orders and Task View | M005 external task-trigger endpoint | Hard dependency is M002 closure; scheduled after M004 for ordered handoff clarity. Plan: `plans/implementation/project-work-orders-task-view/005-external-task-trigger-endpoint.md`. |
| Project Work Orders and Task View | M006 agent WorkOrder tool and atomic batches | Hard dependency is M002/M001 service closure; scheduled after M005 for ordered handoff clarity. Plan: `plans/implementation/project-work-orders-task-view/006-agent-work-order-tool-and-batches.md`. |
