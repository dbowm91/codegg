...
|---|---|---|---|---|
| Architecture convergence and incomplete verticals | active | `plans/subsystems/architecture-convergence-incomplete-verticals-roadmap.md` | M005 closed; M006/M007/M008 ready | — |
...
1. M001-M004 are conditionally closed; M005 is closed; M006, M007, and M008 remain dependency-ready. M001's named host-toolchain focused-test rerun remains an operational condition, not a blocker to the stable context interface.
