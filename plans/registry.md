...
| Tool-selection advisor sequence-encoder experiment | Existing live-primary-model M004 | M005 closed with disposition D; no positive offline disposition exists, so the live study remains blocked. |
