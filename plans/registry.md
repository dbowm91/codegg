...
|---|---|---|---|---|
| Team collaboration, shared sessions, and Workspace chat — corrective | active | `plans/subsystems/team-collaboration-corrective-addendum.md` | M001+M002+M003+M004 closed; M005 ready; M006 blocked | M001 network authorization convergence closed (`plans/closure/team-collaboration-corrective/001-status.md`; implementation `cc41e4a4`); M002 chat access policy closed (`plans/closure/team-collaboration-corrective/002-status.md`; implementation `2f4bec32`); M003 team membership and device-token administration closed (`plans/closure/team-collaboration-corrective/003-status.md`; implementation `f7afefb1`); M004 shared-session controller lease closed (`plans/closure/team-collaboration-corrective/004-status.md`; implementation `1bc967c1`); M005 remains ready; M006 remains blocked on M001-M005. ADR-0006 and ADR-0007 accepted. |
...
| Team collaboration corrective | M005 Workspace selected-project chat view | ready | `plans/implementation/team-collaboration-corrective/005-workspace-selected-project-chat-view.md` | Unblocked by M002 closure; M001+M002 hard dependencies closed; consumes accepted ADR-0006 DTOs. |
...
**Team collaboration corrective gate:** M001 network authorization convergence is closed (`plans/closure/team-collaboration-corrective/001-status.md`; implementation `cc41e4a4`). M002 project/channel chat access policy is closed (`plans/closure/team-collaboration-corrective/002-status.md`; implementation `2f4bec32`). M003 team membership and device-token administration is closed (`plans/closure/team-collaboration-corrective/003-status.md`; implementation `f7afefb1`). M004 shared-session controller lease is closed (`plans/closure/team-collaboration-corrective/004-status.md`; implementation `1bc967c1`). M005 is ready and may proceed; M006 is the final cross-cutting qualification gate. See `plans/subsystems/team-collaboration-corrective-addendum.md`.
...
|---|---|---|
| Team collaboration corrective | M006 multi-user trajectory/security qualification | Blocked on M001-M005 strict closure (M001+M002+M003+M004 closed; M005 ready). |
