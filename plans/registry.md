...
| Team collaboration corrective | M004 shared-session controller lease | ready | `plans/implementation/team-collaboration-corrective/004-shared-session-controller-lease.md` | Unblocked by M001 closure; hard dependency satisfied; consumes accepted ADR-0007. |
