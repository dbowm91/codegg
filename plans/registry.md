...
| Tool-selection advisor sequence-encoder experiment | active | `plans/subsystems/tool-selection-advisor-sequence-encoder-experiment-roadmap.md` | P001 + M001 + M002 ready | New true sequence-encoder experiment using fixed clean evidence infrastructure; M003-M005 gated. Live M004 remains blocked until a positive M005 disposition. |
...
| Tool-selection advisor sequence-encoder experiment | P001 evidence/preregistration polish | ready | `plans/implementation/tool-selection-advisor-sequence-encoder-experiment/001-evidence-preregistration-polish.md` | Reconcile stale C004/framework/CI state and require separate-commit preregistration for future positive qualification. |
