...
| Team collaboration corrective | M004 shared-session controller lease | active | `plans/implementation/team-collaboration-corrective/004-shared-session-controller-lease.md` | Unblocked by M001 closure; hard dependency satisfied; consumes accepted ADR-0007. |
...
|---|---|---|
| Team collaboration corrective | M006 multi-user trajectory/security qualification | Blocked on M001-M005 strict closure (M001+M002+M003 closed; M004/M005 ready). |
