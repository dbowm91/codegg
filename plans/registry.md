...
| Tool-selection advisor evidence-integrity corrective | active | `plans/subsystems/tool-selection-advisor-evidence-integrity-corrective-addendum.md` | C001 closed; C002 + C003 ready; C004 gated | Repairs cross-split content leakage, contextual optimizer/calibration correctness, and deferred-candidate truncation before any live M004 provider study. |
...
| Tool-selection advisor evidence-integrity corrective | C002 contextual training math/calibration | ready | `plans/implementation/tool-selection-advisor-evidence-integrity-corrective/002-contextual-training-math-calibration.md` | Unblocked by C001 closure; retrain only against frozen C001 partitions. |
...
| Tool-selection advisor evidence-integrity corrective | C004 clean offline requalification | C002+C003 closure. Must produce a positive offline disposition before live provider qualification is allowed. |
