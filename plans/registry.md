...
| Tool-selection advisor post-closure corrective | M003 pre-turn proactive disclosure | closing | `plans/implementation/tool-selection-advisor-post-closure-corrective/003-pre-turn-proactive-tool-disclosure.md` | Implementation `3b6c68a` landed; closure evidence is under review; M004 remains blocked until M003 is accepted closed. |
