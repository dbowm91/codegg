...
| Tool-selection advisor sequence-encoder experiment | active | `plans/subsystems/tool-selection-advisor-sequence-encoder-experiment-roadmap.md` | M001 closed; M001A conditional; M001B closed; M002 closed; M003 ready (all stages) | MiniLM asset/load/head-training/pooling qualified; M001B restored differentiable unfreezing (parity max 2.3e-06, scoped top-layer updates). M003 stages 2–3 authorized via the M001B path. |
...
| Tool-selection advisor sequence-encoder experiment | M003 sequence-encoder ranking experiment | ready | `plans/implementation/tool-selection-advisor-sequence-encoder-experiment/004-sequence-encoder-ranking-experiment.md` | All three training stages authorized on the qualified MiniLM asset via the M001B differentiable path (parity max 2.3e-06, scoped top-layer updates); M003's own dev-signal/overfitting gates still apply. |
