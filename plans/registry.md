...
| Tool-selection advisor sequence qualification corrective | active | `plans/subsystems/tool-selection-advisor-sequence-qualification-corrective-addendum.md` | C002 active | C001 repaired the harness and froze the fresh holdout; C002 preregistration is frozen before final qualification. Historical M005 remains closed. |
...
| Tool-selection advisor sequence qualification corrective | C002 preregistered release qualification | active | `plans/implementation/tool-selection-advisor-sequence-qualification-corrective/002-preregistered-release-qualification.md` | C001 closure satisfies the hard dependency; Commit A freezes the protocol before one final release-mode holdout run. |
...
| Tool-selection advisor sequence-encoder experiment | Existing live-primary-model M004 | Historical M005 remains disposition D. A new qualification corrective is active; live M004 remains blocked unless corrective C002 records disposition A, after which original operator/provider/live-trajectory prerequisites still apply. |
