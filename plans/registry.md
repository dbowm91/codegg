...
| Tool-selection advisor post-closure corrective | M003 pre-turn proactive disclosure | active | `plans/implementation/tool-selection-advisor-post-closure-corrective/003-pre-turn-proactive-tool-disclosure.md` | Implementation and closure evidence in progress; M004 remains blocked until M003 is accepted closed. |
...
| Tool-selection advisor post-closure corrective | M004 live small-model trajectory qualification | M003 closure; M001 dataset/consent and M002 contextual encoder are closed, but true pre-turn disclosure is still required. |
