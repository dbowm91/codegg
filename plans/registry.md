...
|---|---|---|---|---|
| Context continuity and multi-compaction coherence | active | `plans/subsystems/context-continuity-compaction-roadmap.md` | M001+M002+M003 closed; M004 ready | M003 closed; M004 unblocked by M002+M003 closure. |
...
| Context continuity and multi-compaction coherence | M004 transactional rollover and multi-compaction qualification | ready | `plans/implementation/context-continuity-compaction/004-transactional-rollover-and-multi-compaction-qualification.md` | Unblocked by M002+M003 accepted closure. |

## Current execution order and dependency gates

1. Context continuity M001+M002+M003 are closed: the durable checkpoint/epoch store (M001), the authoritative intent/plan/frame projection (M002, in-memory candidates, no durable rollover change), and bounded exact recovery references (M003, checkpoint-scoped evidence handles through the existing artifact store) have landed. M004 is now dependency-ready and may proceed.
