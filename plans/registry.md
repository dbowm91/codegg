...
|---|---|---|---|---|
| Project Work Orders and Task View | closed | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002+M003+M004+M005+M006+M007 closed | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001-M007 satisfy the full capability. |
