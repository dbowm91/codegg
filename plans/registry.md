...
| Tool-selection advisor | active | `plans/subsystems/tool-selection-advisor-roadmap.md` | M003 and M004 ready; M005 dependency-gated | Accepted ADR-0009; M001 and M002 closed with data/runtime evidence. |
...
| Tool-selection advisor | M003 local Rust training/model lifecycle | ready | `plans/implementation/tool-selection-advisor/003-local-rust-training-and-model-lifecycle.md` | M002 closed at `plans/closure/tool-selection-advisor/002-status.md`; trainer must emit the accepted artifact contract. |
