...
| Tool-selection advisor | M005 advisor integration/qualification | ready | `plans/implementation/tool-selection-advisor/005-advisor-integration-and-qualification.md` | M001-M004 closure records accepted; qualification is next. |
