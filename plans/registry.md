...
| Tool-selection advisor sequence-encoder experiment | active | `plans/subsystems/tool-selection-advisor-sequence-encoder-experiment-roadmap.md` | M001 active; M002 ready | New true sequence-encoder experiment using fixed clean evidence infrastructure; M003-M005 gated. Live M004 remains blocked until a positive M005 disposition. |
...
| Tool-selection advisor sequence-encoder experiment | M001 Rust sequence-encoder framework/asset spike | active | `plans/implementation/tool-selection-advisor-sequence-encoder-experiment/002-rust-sequence-encoder-framework-asset-spike.md` | Qualify Candle/Burn plus explicit local TinyBERT/MiniLM-class assets; no production framework selected yet. |
