...
|---|---|---|---|---|
| Long-horizon work execution | active | `plans/subsystems/long-horizon-work-execution-roadmap.md` | M001+M002+M003 closed; M004 ready; M005 dependency-blocked | ADR-0003 accepted; M001 closed (`plans/closure/long-horizon-work-execution/001-status.md`); M002 closed (`plans/closure/long-horizon-work-execution/002-status.md`); M003 closed (`plans/closure/long-horizon-work-execution/003-status.md`). M004 ready on the M003 contract, then M005 is dependency ordered. |
...
| Long-horizon work execution | M004 context-epoch reset and handoff integration | ready | `plans/implementation/long-horizon-work-execution/004-context-epoch-reset-and-handoff-integration.md` | Unblocked by M003 closure; hard dependencies on M003 and closed context-continuity satisfied. |
...
|---|---|---|
| Long-horizon work execution | M005 long-horizon trajectory qualification | M004 closure (M001+M002+M003 closed). |
