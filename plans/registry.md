...
| Tool-selection advisor post-closure corrective | M002 contextual encoder runtime/training | active | `plans/implementation/tool-selection-advisor-post-closure-corrective/002-contextual-encoder-runtime-and-training.md` | Implementation in progress against M001 frozen corpus/splits/consent. |
