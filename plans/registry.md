...
|---|---|---|---|---|
| Project Work Orders and Task View | active | `plans/subsystems/project-work-orders-task-view-roadmap.md` | M001+M002+M003 closed; M004 ready; M005-M007 blocked on ordered predecessors | ADR-0005 accepted. Closed project/session/scheduler/worktree/authorization/runtime-preference/WorkPlan foundations plus M001+M002+M003 satisfy M004 dependencies. M005-M007 are registered below and remain blocked until their declared predecessor closures. |
...
| Project Work Orders and Task View | M004 global Workspace dashboard | ready | `plans/implementation/project-work-orders-task-view/004-global-workspace-dashboard.md` | M003 closed (`plans/closure/project-work-orders-task-view/003-status.md`); this is the only dependency-ready WorkOrder milestone. |
...
1. Project Work Orders and Task View M001+M002+M003 are closed under accepted ADR-0005 (M001: durable WorkOrder/Occurrence/SequenceLane domain, project-scoped authorization/protocol, CAS mutation foundation, no execution; M002: release coordinator with exactly-once claim/materialization into ordinary sessions/jobs through `JobSubmissionService`, managed-worktree isolation, model/policy narrowing; M003: Task composer/scheduling sheet/project Task view with CAS reorder and separately-scoped Task-model preference, `/tasks` migration). Closure evidence at `plans/closure/project-work-orders-task-view/001-status.md` (implementation `a856f2e0`), `plans/closure/project-work-orders-task-view/002-status.md` (implementation `c54656e5`), and `plans/closure/project-work-orders-task-view/003-status.md` (implementation `79a00460`). M004 is dependency-ready on those closures. M005-M007 remain blocked and MUST NOT be started by treating their plan files as independent ready work.
