...
| Tool-selection advisor post-closure corrective | M001 dataset/split/consent integrity | active | `plans/implementation/tool-selection-advisor-post-closure-corrective/001-dataset-split-and-consent-integrity.md` | Implementation in progress; expands evidence and makes consent authority unambiguous before encoder work. |
