...
| Tool-selection advisor evidence-integrity corrective | active | `plans/subsystems/tool-selection-advisor-evidence-integrity-corrective-addendum.md` | C001 + C003 ready; C002 + C004 gated | Repairs cross-split content leakage, contextual optimizer/calibration correctness, and deferred-candidate truncation before any live M004 provider study. |
...
| Tool-selection advisor evidence-integrity corrective | C001 content-derived corpus/split integrity | ready | `plans/implementation/tool-selection-advisor-evidence-integrity-corrective/001-content-derived-corpus-split-integrity.md` | Correct known exact/normalized cross-split duplication and establish true optimizer-excluded family holdouts. |
...
| Tool-selection advisor evidence-integrity corrective | C002 contextual training math/calibration | C001 must close with clean frozen train/dev/test and true family-holdout partitions before corrected retraining/qualification. |
| Tool-selection advisor evidence-integrity corrective | C004 clean offline requalification | C001+C002+C003 closure. Must produce a positive offline disposition before live provider qualification is allowed. |
