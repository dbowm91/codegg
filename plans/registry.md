...
| Tool-selection advisor evidence-integrity corrective | active | `plans/subsystems/tool-selection-advisor-evidence-integrity-corrective-addendum.md` | C001 + C002 closed; C003 ready; C004 gated | Repairs cross-split content leakage, contextual optimizer/calibration correctness, and deferred-candidate truncation before any live M004 provider study. |
...
| Tool-selection advisor evidence-integrity corrective | C003 deferred-first candidate shortlisting | ready | `plans/implementation/tool-selection-advisor-evidence-integrity-corrective/003-deferred-first-candidate-shortlisting.md` | Independent of model retraining; preserves M003 authority seam while applying candidate limits after deferred eligibility. |
...
| Tool-selection advisor evidence-integrity corrective | C004 clean offline requalification | C003 closure. Must produce a positive offline disposition before live provider qualification is allowed. |
