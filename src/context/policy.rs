...
pub fn decide_policy(
    ...
    let is_review = analysis.recommended_action == EffectiveCostAction::ReviewToolPalette;
...
mod tests {
    ...
    fn disabled_always_noop() {
        ...
        let d = decide_policy(&a, 30, &cfg, Some("BeforeProviderCall"), 10);
    ...
    fn observe_always_noop() {
        ...
        let a = make_analysis(EffectiveCostAction::ReviewToolPalette);
        let d = decide_policy(&a, 30, &cfg, None, 10);
        assert_eq!(d.kind, ContextPolicyDecisionKind::Noop);
    ...
    fn warn_produces_warnonly_no_mutation() {
        ...
        let a = make_analysis(EffectiveCostAction::ReviewToolPalette);
        let d = decide_policy(&a, 30, &cfg, Some("BeforeProviderCall"), 5);
    ...
    fn reduce_noop_when_not_enough_obs() {
        ...
        let a = make_analysis(EffectiveCostAction::ReviewToolPalette);
        let d = decide_policy(&a, 30, &cfg, Some("BeforeProviderCall"), 2);
        assert_eq!(d.kind, ContextPolicyDecisionKind::Noop);
    }
    ...
    fn reduce_noop_when_not_over_cap() {
        ...
        let a = make_analysis(EffectiveCostAction::ReviewToolPalette);
        let d = decide_policy(&a, 20, &cfg, Some("BeforeProviderCall"), 5);
        assert_eq!(d.kind, ContextPolicyDecisionKind::Noop);
    }
    ...
    fn reduce_noop_when_phase_not_provider() {
        let cfg = make_config(true, ContextPolicyMode::ToolPaletteReduce, 3, 10);
        let a = make_analysis(EffectiveCostAction::ReviewToolPalette);
        let d = decide_policy(&a, 30, &cfg, Some("AfterToolResults"), 5);
        assert_eq!(d.kind, ContextPolicyDecisionKind::Noop);
    }
