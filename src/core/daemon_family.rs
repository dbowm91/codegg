...
impl DaemonRequestFamily {
    ...
    pub fn of(request: &CoreRequest) -> Self {
        match request {
            ...
            CoreRequest::SessionControlRelease { .. } => Self::Turns,
            CoreRequest::SessionControlTakeover { .. } => Self::Turns,
            ...
            CoreRequest::ApprovalPreferenceGet => Self::Ops,
            ...
            CoreRequest::ChatChannelPolicySet { .. } => Self::Chat,
            ...
            CoreRequest::ChatPolicyGet { .. } => Self::Chat,
            CoreRequest::ChatPolicyList { .. } => Self::Chat,
            CoreRequest::ChatProjectPolicySet { .. } => Self::Chat,
            ...
            CoreRequest::WorkOrderTriggerCreate { .. } => Self::WorkOrders,
            CoreRequest::WorkOrderTriggerGet { .. } => Self::WorkOrders,
            CoreRequest::WorkOrderTriggerList { .. } => Self::WorkOrders,
            CoreRequest::WorkOrderTriggerRevoke { .. } => Self::WorkOrders,
