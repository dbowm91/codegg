...
pub fn server_definitions() -> &'static [LspServerDef] {
    &[
        ...
        LspServerDef {
            id: "perl-language-server",
            languages: &["perl", "raku"],
            extensions: &["pl", "pm", "raku"],
            repo: "richterperl/Perl-LanguageServer",
        ...
        LspServerDef {
            ...
            command: "pwsh",
            args: &["-NoProfile", "-c", "pwsh -PSEditorServices::Start-EditorServices"],
            download: None,
        },
        LspServerDef {
        ...
        LspServerDef {
            id: "buf-language-server",
            languages: &["proto"],
            extensions: &["proto"],
            repo: "bufbuild/buf-language-server",
            command: "buf-language-server",
            args: &["serve"],
            download: None,
        },
        LspServerDef {
            ...
            command: "R",
            args: &["--slave", "-e", "library(languageserver)"],
            download: None,
        },
        LspServerDef {
            id: "nimlsp",
