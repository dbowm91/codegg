...
pub const PLUGIN_ID: &str = "builtin:poe";
pub const HANDLER_ID: &str = "poe";

/// Return the canonical manifest for the Poe builtin plugin.
pub fn manifest() -> PluginManifest {
    PluginManifest {
        name: "poe".into(),
        version: "0.1.0".into(),
        description: Some("Poe authentication provider".into()),
...
pub fn plugin_info() -> (
    ...
    make_builtin_info("poe", "0.1.0", vec![("auth", 0)])
}
