...
pub const PLUGIN_ID: &str = "builtin:codex";
pub const HANDLER_ID: &str = "codex";

/// Return the canonical manifest for the Codex builtin plugin.
pub fn manifest() -> PluginManifest {
    PluginManifest {
        name: "codex".into(),
        version: "0.1.0".into(),
        description: Some("OpenAI Codex authentication provider".into()),
...
pub fn plugin_info() -> (
    ...
    make_builtin_info("codex", "0.1.0", vec![("auth", 0)])
}
